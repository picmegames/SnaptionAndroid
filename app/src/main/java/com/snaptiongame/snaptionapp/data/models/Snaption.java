...
public final class Snaption {
   ...
   @ParcelConstructor
   public Snaption(String id, long startDate, long endDate, boolean isPrivate, String pickerName,
                   int pickerId, String encodedImage, String picture, String type, List<Caption> captions) {
      this.id = id;
