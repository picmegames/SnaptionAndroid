...
public class ImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
   ...
   public ImageBehavior(Context context, AttributeSet attrs) {
      ...
      if (attrs != null) {
         ...
         mCustomFinalYPosition = array.getDimension(R.styleable.ImageBehavior_finalYPosition, 0);
         mCustomStartXPosition = array.getDimension(R.styleable.ImageBehavior_startXPosition, 0);
         mCustomStartToolbarPosition = array.getDimension(R.styleable.ImageBehavior_startToolbarPosition, 0);
         mCustomStartHeight = array.getDimension(R.styleable.ImageBehavior_startHeight, 0);
         mCustomFinalHeight = array.getDimension(R.styleable.ImageBehavior_finalHeight, 0);
